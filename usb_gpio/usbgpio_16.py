...
def main():
    ...
    try:
        with serial.Serial(port_name, baud_rate, timeout=timeout) as ser_port:
            ...
            if isinstance(gpio_number, str) and len(gpio_number) == 1 and gpio_number in '0123456789ABCDEF':
                ...
                print(f"Error: GPIO number must be one of the digits between 0-9 and A-F.")
