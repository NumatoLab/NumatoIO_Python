    ...
    try:
        with serial.Serial(port_name, baud_rate, timeout=timeout) as ser_port:
            ...
            try:
                ...
                if isinstance(adc_channel, int) and 1 <= adc_channel <= 7:
                    ...
                    print(f"Error: adc_channel must be one of the digits between 1 and 7.")
            ...
            if isinstance(gpio_number, str) and len(gpio_number) == 1 and gpio_number in '0123456789ABCDEFGHIJKLMNOPQRSTUV':
                ...
                print(f"Error: GPIO number must be one of the digits between 0-9 and A-V.")
